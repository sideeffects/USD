...
static double
NormalizeHelper(GfVec3d *vec, double eps = GF_MIN_VECTOR_LENGTH)
{
...
static bool
OrthogonalizeBasisHelper( GfVec3d *v1, GfVec3d *v2, GfVec3d *v3,
			  bool normalize,
...
static tuple
BuildOrthonormalFrameHelper(const GfVec3d &self,
...
static int __len__(const GfVec3d &self) { return 3; }
...
struct FromPythonTuple {
  ...
  private:
    ...
    static void _construct(PyObject *obj_ptr, converter::
        ...
        typedef double Scalar;
        void *storage = ((converter::rvalue_from_python_storage<GfVec3d>*)data)
	    ->storage.bytes;
        new (storage)
	    GfVec3d(
...
void wrapVec3d()
{
    ...
    cls
        ...
        ;
    to_python_converter<std::vector<GfVec3d>,
        TfPySequenceToPython<std::vector<GfVec3d> > >();
